...
public class Day{
    ...
    public Day(int avghumidity, double avgtemp_c, double avgtemp_f, double avgvis_km, double avgvis_miles, Condition condition, int daily_chance_of_rain, int daily_chance_of_snow, int daily_will_it_rain, int daily_will_it_snow, double maxtemp_c, double maxtemp_f, double maxwind_kph, double maxwind_mph, double mintemp_c, double mintemp_f, double totalprecip_in, double totalprecip_mm, double totalsnow_cm, double uv) {
