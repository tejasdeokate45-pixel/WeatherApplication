...
public class Hour{
    ...
    public Hour(int chance_of_rain, int chance_of_snow, int cloud, Condition condition, double dewpoint_c, double dewpoint_f, double diff_rad, double dni, double feelslike_c, double feelslike_f, double gti, double gust_kph, double gust_mph, double heatindex_c, double heatindex_f, int humidity, int is_day, double precip_in, double precip_mm, double pressure_in, double pressure_mb, double short_rad, double snow_cm, double temp_c, double temp_f, String time, int time_epoch, double uv, double vis_km, double vis_miles, int will_it_rain, int will_it_snow, int wind_degree, String wind_dir, double wind_kph, double wind_mph, double windchill_c, double windchill_f) {
